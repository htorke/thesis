...
if (surf1x > 12.7) || (surf2x > 12.7) || (surf3x > 12.7)
    flag = 1;
end
...
line(linspace(-focal_length,75,10),surf1x*ones(1,10));
line(linspace(-focal_length,75,10),-surf1x*ones(1,10));

xlim([-focal_length 75])
ylim([-12.7 12.7])
hold off;

fill_width = 2*surf1x
fill_pecentage = 100*(pi*surf1x^2)/(pi*12.7^2)
